# Azeo Simulation Workbench User Manual

Edition 1.0 - 23 September 2026
Application baseline: `0.4.0`
Document ID: AZEO-UM-SIMULATION

Simulation controls, snapshots, playback and instructor exercises. This guide uses the current Azeo application names and real
...
| Goal | Where to go |
| --- | --- |
| Set up and step a training simulation | Relevant numbered section below |
| Save a starting snapshot and restore selected content | Relevant numbered section below |
| Run an exercise and review the session timeline | Relevant numbered section below |
